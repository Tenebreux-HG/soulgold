...
// Overworld Debug
#define DEBUG_OVERWORLD_MENU            DISABLED_ON_RELEASE //DISABLED_ON_RELEASE or False Enables an overworld debug menu to change flags, variables, giving pokemon and more, accessed by holding R and pressing START while in the overworld by default.
